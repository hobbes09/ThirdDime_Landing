...
REPO_URL = 'https://github.com/hobbes09/ThirdDime_Landing.git'
...
def _update_settings(source_folder, site_name):
    settings_path = source_folder + '/thirdDime/settings.py'
    sed(settings_path, "DEBUG = True", "DEBUG = False")
    sed(settings_path,
        'ALLOWED_HOSTS =.+$',
        'ALLOWED_HOSTS = ["%s", "thirddime.com"]' % (site_name,)
        )
    secret_key_file = source_folder + '/thirdDime/secret_key.py'
